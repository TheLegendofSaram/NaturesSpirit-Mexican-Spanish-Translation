...
public class NSMiscBlocks {
  ...
  public static final Block RED_MOSS_BLOCK = registerBlock("red_moss_block",
      new RedMossBlock(AbstractBlock.Settings.create().mapColor(MapColor.RED).strength(0.1F).sounds(BlockSoundGroup.MOSS_BLOCK).pistonBehavior(PistonBehavior.DESTROY)),
      Items.MOSS_BLOCK, ItemGroups.NATURAL);

  public static final Block RED_MOSS_CARPET = registerBlock("red_moss_carpet",
      new CarpetBlock(AbstractBlock.Settings.create().mapColor(MapColor.RED).strength(0.1F).sounds(BlockSoundGroup.MOSS_CARPET).pistonBehavior(PistonBehavior.DESTROY)),
  ...
  public static final Block SMOOTH_PINK_SANDSTONE_STAIRS = registerBlock("smooth_pink_sandstone_stairs",
      ...
      SMOOTH_PINK_SANDSTONE, ItemGroups.BUILDING_BLOCKS);
  ...
  public static final Block TALL_FRIGID_GRASS = registerTallPlantBlock("tall_frigid_grass", new SemiTallGrassBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.LICHEN_GREEN).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
              .pistonBehavior(PistonBehavior.DESTROY)),
      Blocks.LARGE_FERN, 0.3f);

  public static final Block FRIGID_GRASS = registerPlantBlock("frigid_grass", new NSFernBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.LICHEN_GREEN).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS)
              .offset(AbstractBlock.OffsetType.XYZ).pistonBehavior(PistonBehavior.DESTROY), (TallPlantBlock) TALL_FRIGID_GRASS),
      Blocks.FERN, 0.3f);
  ...
  public static final Block SCORCHED_GRASS = registerPlantBlock("scorched_grass", new LargeDesertFernBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.LICHEN_GREEN).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS)
              .offset(AbstractBlock.OffsetType.XYZ).pistonBehavior(PistonBehavior.DESTROY), (TallPlantBlock) TALL_SCORCHED_GRASS),
      Blocks.FERN, 0.3f);

  public static final Block TALL_BEACH_GRASS = registerTallPlantBlock("tall_beach_grass", new TallLargeDesertFernBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
              .pistonBehavior(PistonBehavior.DESTROY)),
      Blocks.LARGE_FERN, 0.3f);

  public static final Block BEACH_GRASS = registerPlantBlock("beach_grass", new LargeDesertFernBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XYZ)
  ...
  public static final Block TALL_SEDGE_GRASS = registerTallPlantBlock("tall_sedge_grass", new TallSedgeGrassBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.DARK_GREEN).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
              .pistonBehavior(PistonBehavior.DESTROY)),
      TALL_SCORCHED_GRASS, 0.3f);

  public static final Block SEDGE_GRASS = registerPlantBlock("sedge_grass", new SedgeGrassBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.DARK_GREEN).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XYZ)
              .pistonBehavior(PistonBehavior.DESTROY)),
      SCORCHED_GRASS, 0.3f);

  public static final Block LARGE_FLAXEN_FERN = registerTallPlantBlock("large_flaxen_fern", new TallPlantBlock(
          AbstractBlock.Settings.create().noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
              .pistonBehavior(PistonBehavior.DESTROY)),
      TALL_SEDGE_GRASS, 0.3f);

  public static final Block FLAXEN_FERN = registerPlantBlock("flaxen_fern", new NSFernBlock(
          AbstractBlock.Settings.create().noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XYZ)
  ...
  public static final Block TALL_OAT_GRASS = registerTallPlantBlock("tall_oat_grass", new SemiTallGrassBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.PALE_YELLOW).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
          .pistonBehavior(PistonBehavior.DESTROY)), LARGE_FLAXEN_FERN, 0.3f);

  public static final Block OAT_GRASS = registerPlantBlock("oat_grass", new NSFernBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.PALE_YELLOW).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XYZ)
              .pistonBehavior(PistonBehavior.DESTROY), (TallPlantBlock) TALL_OAT_GRASS),
      FLAXEN_FERN, 0.3f);

  public static final Block LARGE_LUSH_FERN = registerTallPlantBlock("large_lush_fern", new TallPlantBlock(
      AbstractBlock.Settings.create().noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
          .pistonBehavior(PistonBehavior.DESTROY)), TALL_OAT_GRASS, 0.3f);

  public static final Block LUSH_FERN = registerPlantBlock("lush_fern", new NSFernBlock(
      AbstractBlock.Settings.create().noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XYZ)
          .pistonBehavior(PistonBehavior.DESTROY), (TallPlantBlock) LARGE_LUSH_FERN), OAT_GRASS, 0.3f);

  public static final Block TALL_MELIC_GRASS = registerTallPlantBlock("tall_melic_grass", new TallPlantBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
          .pistonBehavior(PistonBehavior.DESTROY)), LARGE_LUSH_FERN, 0.3f);

  public static final Block MELIC_GRASS = registerPlantBlock("melic_grass", new NSFernBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XYZ)
          .pistonBehavior(PistonBehavior.DESTROY), (TallPlantBlock) TALL_MELIC_GRASS), LUSH_FERN, 0.3f);
  ...
  public static final Block PURPLE_BITTER_SPROUTS = registerPlantBlock("purple_bitter_sprouts", new LargeSproutsBlock(
      AbstractBlock.Settings.create().noCollision().replaceable().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ)
          .pistonBehavior(PistonBehavior.DESTROY)), RED_BITTER_SPROUTS, 0.3f);

  public static final Block CATTAIL = registerPlantBlock("cattail", new CattailBlock(
          AbstractBlock.Settings.create().mapColor(MapColor.DARK_GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS).burnable().pistonBehavior(PistonBehavior.DESTROY)),
  ...
  public static final Block AZOLLA = NSRegistryHelper.registerTransparentBlockWithoutTab("azolla", new AzollaBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.GREEN).pistonBehavior(PistonBehavior.DESTROY).ticksRandomly().nonOpaque().breakInstantly().noCollision()
          .sounds(BlockSoundGroup.LILY_PAD)));

  public static final Item AZOLLA_ITEM = registerItem("azolla", new AzollaItem(AZOLLA, new Item.Settings()), Items.LILY_PAD, ItemGroups.NATURAL);

  public static final Block ORNATE_SUCCULENT = registerTransparentBlockWithoutTab("ornate_succulent",
      new SucculentBlock(AbstractBlock.Settings.create().mapColor(MapColor.RED).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly()));

  public static final Block DROWSY_SUCCULENT = registerTransparentBlockWithoutTab("drowsy_succulent",
      new SucculentBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly()));

  public static final Block AUREATE_SUCCULENT = registerTransparentBlockWithoutTab("aureate_succulent",
      new SucculentBlock(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly()));

  public static final Block SAGE_SUCCULENT = registerTransparentBlockWithoutTab("sage_succulent",
      new SucculentBlock(AbstractBlock.Settings.create().mapColor(MapColor.DARK_GREEN).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly()));

  public static final Block FOAMY_SUCCULENT = registerTransparentBlockWithoutTab("foamy_succulent",
      new SucculentBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly()));

  public static final Block IMPERIAL_SUCCULENT = registerTransparentBlockWithoutTab("imperial_succulent",
      new SucculentBlock(AbstractBlock.Settings.create().mapColor(MapColor.PURPLE).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly()));

  public static final Block REGAL_SUCCULENT = registerTransparentBlockWithoutTab("regal_succulent",
      new SucculentBlock(AbstractBlock.Settings.create().mapColor(MapColor.PINK).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly()));

  public static final Block ORNATE_WALL_SUCCULENT = registerTransparentBlockWithoutTab("ornate_wall_succulent",
      new SucculentWallBlock(AbstractBlock.Settings.create().mapColor(MapColor.RED).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly().dropsLike(ORNATE_SUCCULENT)));

  public static final Block DROWSY_WALL_SUCCULENT = registerTransparentBlockWithoutTab("drowsy_wall_succulent",
      new SucculentWallBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly().dropsLike(DROWSY_SUCCULENT)));

  public static final Block AUREATE_WALL_SUCCULENT = registerTransparentBlockWithoutTab("aureate_wall_succulent",
      new SucculentWallBlock(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly().dropsLike(AUREATE_SUCCULENT)));

  public static final Block SAGE_WALL_SUCCULENT = registerTransparentBlockWithoutTab("sage_wall_succulent",
      new SucculentWallBlock(AbstractBlock.Settings.create().mapColor(MapColor.DARK_GREEN).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly().dropsLike(SAGE_SUCCULENT)));
  ...
  public static final Block FOAMY_WALL_SUCCULENT = registerTransparentBlockWithoutTab("foamy_wall_succulent", new SucculentWallBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly().dropsLike(FOAMY_SUCCULENT)));

  public static final Block IMPERIAL_WALL_SUCCULENT = registerTransparentBlockWithoutTab("imperial_wall_succulent",
      new SucculentWallBlock(AbstractBlock.Settings.create().mapColor(MapColor.PURPLE).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly().dropsLike(IMPERIAL_SUCCULENT)));

  public static final Block REGAL_WALL_SUCCULENT = registerTransparentBlockWithoutTab("regal_wall_succulent",
      new SucculentWallBlock(AbstractBlock.Settings.create().mapColor(MapColor.PINK).sounds(BlockSoundGroup.GRASS).noCollision().breakInstantly().dropsLike(REGAL_SUCCULENT)));

  public static final Item ORNATE_SUCCULENT_ITEM = registerItem("ornate_succulent",
      new VerticallyAttachableBlockItem(ORNATE_SUCCULENT, ORNATE_WALL_SUCCULENT, new Item.Settings(), Direction.DOWN), Items.PITCHER_PLANT, ItemGroups.NATURAL);

  public static final Item DROWSY_SUCCULENT_ITEM = registerItem("drowsy_succulent",
      new VerticallyAttachableBlockItem(DROWSY_SUCCULENT, DROWSY_WALL_SUCCULENT, new Item.Settings(), Direction.DOWN), ORNATE_SUCCULENT_ITEM, ItemGroups.NATURAL);

  public static final Item AUREATE_SUCCULENT_ITEM = registerItem("aureate_succulent",
      new VerticallyAttachableBlockItem(AUREATE_SUCCULENT, AUREATE_WALL_SUCCULENT, new Item.Settings(), Direction.DOWN), DROWSY_SUCCULENT_ITEM, ItemGroups.NATURAL);

  public static final Item SAGE_SUCCULENT_ITEM = registerItem("sage_succulent",
      new VerticallyAttachableBlockItem(SAGE_SUCCULENT, SAGE_WALL_SUCCULENT, new Item.Settings(), Direction.DOWN), AUREATE_SUCCULENT_ITEM, ItemGroups.NATURAL);

  public static final Item FOAMY_SUCCULENT_ITEM = registerItem("foamy_succulent",
      new VerticallyAttachableBlockItem(FOAMY_SUCCULENT, FOAMY_WALL_SUCCULENT, new Item.Settings(), Direction.DOWN), SAGE_SUCCULENT_ITEM, ItemGroups.NATURAL);

  public static final Item IMPERIAL_SUCCULENT_ITEM = registerItem("imperial_succulent",
      new VerticallyAttachableBlockItem(IMPERIAL_SUCCULENT, IMPERIAL_WALL_SUCCULENT, new Item.Settings(), Direction.DOWN), FOAMY_SUCCULENT_ITEM, ItemGroups.NATURAL);

  public static final Item REGAL_SUCCULENT_ITEM = registerItem("regal_succulent",
      new VerticallyAttachableBlockItem(REGAL_SUCCULENT, REGAL_WALL_SUCCULENT, new Item.Settings(), Direction.DOWN), IMPERIAL_SUCCULENT_ITEM, ItemGroups.NATURAL);

  public static final Block SHIITAKE_MUSHROOM = registerPlantBlock("shiitake_mushroom", new ShiitakeMushroomPlantBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.BROWN).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).luminance((state) -> 1)
  ...
  public static final Block POTTED_SCORCHED_GRASS = registerTransparentBlockWithoutTab("potted_scorched_grass",
      new FlowerPotBlock(SCORCHED_GRASS, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_BEACH_GRASS = registerTransparentBlockWithoutTab("potted_beach_grass",
      new FlowerPotBlock(BEACH_GRASS, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_SEDGE_GRASS = registerTransparentBlockWithoutTab("potted_sedge_grass",
      new FlowerPotBlock(SEDGE_GRASS, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_FLAXEN_FERN = registerTransparentBlockWithoutTab("potted_flaxen_fern",
      new FlowerPotBlock(FLAXEN_FERN, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_OAT_GRASS = registerTransparentBlockWithoutTab("potted_oat_grass",
      new FlowerPotBlock(OAT_GRASS, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_MELIC_GRASS = registerTransparentBlockWithoutTab("potted_melic_grass",
      new FlowerPotBlock(MELIC_GRASS, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_LUSH_FERN = registerTransparentBlockWithoutTab("potted_lush_fern",
      new FlowerPotBlock(LUSH_FERN, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_FRIGID_GRASS = registerTransparentBlockWithoutTab("potted_frigid_grass",
      new FlowerPotBlock(FRIGID_GRASS, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_GREEN_BEARBERRIES = registerTransparentBlockWithoutTab("potted_green_bearberries",
      new FlowerPotBlock(GREEN_BEARBERRIES, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_RED_BEARBERRIES = registerTransparentBlockWithoutTab("potted_red_bearberries",
      new FlowerPotBlock(RED_BEARBERRIES, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_PURPLE_BEARBERRIES = registerTransparentBlockWithoutTab("potted_purple_bearberries",
      new FlowerPotBlock(PURPLE_BEARBERRIES, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_ORNATE_SUCCULENT = registerTransparentBlockWithoutTab("potted_ornate_succulent",
      new FlowerPotBlock(ORNATE_SUCCULENT, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_DROWSY_SUCCULENT = registerTransparentBlockWithoutTab("potted_drowsy_succulent",
      new FlowerPotBlock(DROWSY_SUCCULENT, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_AUREATE_SUCCULENT = registerTransparentBlockWithoutTab("potted_aureate_succulent",
      new FlowerPotBlock(AUREATE_SUCCULENT, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_SAGE_SUCCULENT = registerTransparentBlockWithoutTab("potted_sage_succulent",
      new FlowerPotBlock(SAGE_SUCCULENT, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_FOAMY_SUCCULENT = registerTransparentBlockWithoutTab("potted_foamy_succulent",
      new FlowerPotBlock(FOAMY_SUCCULENT, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_IMPERIAL_SUCCULENT = registerTransparentBlockWithoutTab("potted_imperial_succulent",
      new FlowerPotBlock(IMPERIAL_SUCCULENT, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_REGAL_SUCCULENT = registerTransparentBlockWithoutTab("potted_regal_succulent",
      new FlowerPotBlock(REGAL_SUCCULENT, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));

  public static final Block POTTED_SHIITAKE_MUSHROOM = registerTransparentBlockWithoutTab("potted_shiitake_mushroom",
      new FlowerPotBlock(SHIITAKE_MUSHROOM, AbstractBlock.Settings.create().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));
  ...
  public static final Block HELVOLA = registerTransparentBlockWithoutTab("helvola", new WaterFlowerbedBlock(
      AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.DESTROY).ticksRandomly().nonOpaque().breakInstantly().slipperiness(0.8F).sounds(BlockSoundGroup.LILY_PAD)));

  public static final Item HELVOLA_PAD_ITEM = registerItem("helvola_pad", new PlaceableOnWaterItem(HELVOLA, new Item.Settings()),
      Items.LILY_PAD, ItemGroups.NATURAL);

  public static final Item HELVOLA_FLOWER_ITEM = registerItem("helvola_flower", new Item(new Item.Settings()),
      HELVOLA_PAD_ITEM, ItemGroups.NATURAL);

  public static final Block LOTUS_FLOWER = registerTransparentBlockWithoutTab("lotus_flower", new LotusFlowerBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.PINK).pistonBehavior(PistonBehavior.DESTROY).ticksRandomly().nonOpaque().breakInstantly().sounds(BlockSoundGroup.LILY_PAD)));

  public static final Item LOTUS_FLOWER_ITEM = registerItem("lotus_flower", new PlaceableOnWaterItem(LOTUS_FLOWER, new Item.Settings()),
      HELVOLA_FLOWER_ITEM, ItemGroups.NATURAL);

  public static final Block LOTUS_STEM = registerPlantBlock("lotus_stem", new LotusStemBlock(
      AbstractBlock.Settings.create().mapColor(MapColor.GREEN).pistonBehavior(PistonBehavior.DESTROY).noCollision().nonOpaque().breakInstantly().sounds(BlockSoundGroup.LILY_PAD), LOTUS_FLOWER), LOTUS_FLOWER, 0.2F);

  public static final Block ALLUAUDIA = registerPlantBlock("alluaudia", new GrowingBranchingTrunkBlock(
      AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.DESTROY).mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.5f).strength(.5f).notSolid()), Items.CACTUS, .2f);

  public static final Block STRIPPED_ALLUAUDIA = registerPlantBlock("stripped_alluaudia", new GrowingBranchingTrunkBlock(
      AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.DESTROY).mapColor(MapColor.OAK_TAN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.5f).strength(.5f).notSolid()), NSMiscBlocks.ALLUAUDIA, .2f);

  public static final Block ALLUAUDIA_BUNDLE = registerPlantBlock("alluaudia_bundle",
      new PillarBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.6f).strength(.6f)), STRIPPED_ALLUAUDIA, .2f);
  ...
  public static final Item CHALK_POWDER = registerItem("chalk_powder", new Item((new Item.Settings())), Items.HONEYCOMB, ItemGroups.INGREDIENTS);

  public static final Block CHEESE_BLOCK = registerBlockWithoutTab("cheese_block", new CheeseBlock(AbstractBlock.Settings.create().mapColor(MapColor.PALE_YELLOW).strength(2.0F, 1.0F).sounds(BlockSoundGroup.AZALEA_LEAVES)));
  ...
  public static final Item CALCITE_SHARD = registerItem("calcite_shard", new Item(new Item.Settings()), Items.AMETHYST_SHARD, ItemGroups.INGREDIENTS);

  public static final Block CALCITE_CLUSTER = registerBlock("calcite_cluster", new AmethystClusterBlock(7, 3,
      AbstractBlock.Settings.create().mapColor(MapColor.WHITE).solid().nonOpaque().ticksRandomly().sounds(BlockSoundGroup.CALCITE).strength(1.5F)
          .pistonBehavior(PistonBehavior.DESTROY)), Blocks.AMETHYST_CLUSTER, ItemGroups.NATURAL);
  ...
  public static final Block LARGE_CALCITE_BUD = registerBlock("large_calcite_bud",
      ...
      CALCITE_CLUSTER, ItemGroups.NATURAL);
  ...
  public static final Item PAPER_HANGING_SIGN_ITEM = registerItem("paper_hanging_sign",
      new HangingSignItem(PAPER_HANGING_SIGN, PAPER_WALL_HANGING_SIGN, new Item.Settings().maxCount(16)), PAPER_SIGN_ITEM, ItemGroups.FUNCTIONAL);
